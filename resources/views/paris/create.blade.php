...
@section('content')
    <section class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                {{ Form::open(['route'=>'paris.store', 'files'=>true]) }}
                <fieldset>
                    <legend>Mode</legend>
                    ...
                    <div class="row">
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <input type="number" name="tirage_win[n1]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <input type="number" name="tirage_win[n2]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <input type="number" name="tirage_win[n3]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <input type="number" name="tirage_win[n4]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <input type="number" name="tirage_win[n5]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-2">
                            <div class="form-group">
                                <label for="name">N°1</label>
                                <div class="row">
                                    <input type="number" name="tirage_mac[n1]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <label for="name">N°2</label>
                                <div class="row">
                                    <input type="number" name="tirage_mac[n2]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <label for="name">N°3</label>
                                <div class="row">
                                    <input type="number" name="tirage_mac[n3]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <label for="name">N°4</label>
                                <div class="row">
                                    <input type="number" name="tirage_mac[n4]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <label for="name">N°5</label>
                                <div class="row">
                                    <input type="number" name="tirage_mac[n5]" class="form-control" id="nometab" required>
                                </div>
                            </div>
                        </div>
                    </div>
